...
- (void)setModel:(RecordModel *)model
{
    ...
    _nextTimeLabel.text = [NSString stringWithFormat:@"%@",model.nextTime];
...
- (void)setJiluModel:(RecordModel *)jiluModel
{
    ...
    _nextTimeLabel.text = [NSString stringWithFormat:@"%@",jiluModel.nextTime];
