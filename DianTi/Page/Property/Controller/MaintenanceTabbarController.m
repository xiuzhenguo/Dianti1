...
#import "MaintenanceTabbarController.h"

@interface MaintenanceTabbarController ()

@end

@implementation MaintenanceTabbarController
...
- (void)viewDidLoad {
    ...
    tabBarItem1.selectedImage = [UIImage imageNamed:@"weibao_weibaoguanli_select"];
    ...
    tabBarItem3.selectedImage = [UIImage imageNamed:@"weibao_tongzhi_select"];
