...
#import "PropertyMineViewController.h"
...
#import "ShezhiView.h"
@interface PropertyMineViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation PropertyMineViewController
...
- (void)loadData
{
    ...
    [PropertyManager getMyBaoxiuListWithWYID:[PersonInformation sharedPersonInformation].userID pageIndex:[NSString stringWithFormat:@"%ld",(long)self.pageNum] pageSize:@"10" success:^(id responseObject) {
