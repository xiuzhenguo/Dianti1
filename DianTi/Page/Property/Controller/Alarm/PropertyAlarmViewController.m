...
#import "PropertyAlarmViewController.h"
...
@interface PropertyAlarmViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation PropertyAlarmViewController
...
- (void)loadData
{
    ...
    [PropertyManager getAlarmListWithWYID:[PersonInformation sharedPersonInformation].userID pageIndex:[NSString stringWithFormat:@"%ld",(long)self.pageNum] pageSize:[NSString stringWithFormat:@"%d",kGetNumberOfData] success:^(id responseObject) {
...
//    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    ...
    AlarmModel *model = alermArray[indexPath.row];
    cell.model = model;
    return cell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    AlarmModel *model = alermArray[indexPath.row];
    _detailVC.lid = model.evevator.evevatorID;
}
