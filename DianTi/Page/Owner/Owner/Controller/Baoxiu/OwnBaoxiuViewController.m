...
#import "OwnBaoxiuViewController.h"
...
@interface OwnBaoxiuViewController ()
{
...
@implementation OwnBaoxiuViewController
...
- (void)loadData
{
    ...
    [OwnerManager getRepairElevatorListWithOID:[PersonInformation sharedPersonInformation].userID pageIndex:[NSString stringWithFormat:@"%ld",(long)self.pageNum] pageSize:[NSString stringWithFormat:@"%d",kGetNumberOfData] success:^(id responseObject) {
